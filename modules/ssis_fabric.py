...
class SSIS_Fabric:
    ...
    def create_token(self):
        ...
        try:
            ...
            logging.error(f"Failed to acquire token.\nErr: {e}")
    ...
    def get_workspace_id(self):
        try:
            ...
            logging.error(f"Failed to get workspace id.\nErr: {e}")
    ...
    def get_warehouse_id(self):
        ...
        try:
            ...
            logging.error(f"Failed to retrieve warehouse.\nStatus code: {response.status_code}\nResponse:", response.text)
    ...
    def get_lakehouse_id(self):
        ...
        try:
            ...
            logging.error(f"Failed to retrieve lakehouse.\nStatus code: {response.status_code}\nResponse:", response.text)
    ...
    def get_input_columns_for_merge(inputs): #returns the input column names for one side input of merge join
        ...
        try:
            ...
            logging.error(f"Failed to get input columns for Merge Join.\nErr: {e}")
    ...
    def design_table(table_name, columns, datatypes):
        ...
        query += ");"
        logging.info(f"create table statement designed\n{query}")
        return query
    ...
    def parse_components(self, dataflow, dataflow_name, prev_executable):
        ...
        while count < len(self.component_map.keys()):
            for name, comp_type in self.component_map.items():
                logging.info(f"Parsing component {name}")
    ...
    def parse_ssis_pipeline(self, filepath):
        ...
        for i in range(n):
            ...
            if exec_type == "Microsoft.Pipeline":
                ...
                logging.info(f"Procedure executed in Execute SQL is {procedure_name}")
